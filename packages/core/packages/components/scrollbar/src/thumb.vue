<template>
  <transition name="cl-scrollbar-fade">
    <div
      v-show="always || visible"
      ref="instance"
      :class="['cl-scrollbar__bar', createIsClassName(bar.key)]"
      @mousedown="clickTrackHandler"
    >
      <div
        ref="thumb"
        class="cl-scrollbar__thumb"
        :style="thumbStyle"
...
import { createIsClassName, throwError } from '@kirkw/utils'
